    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-[#0b1120] flex">
            ...
            <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-white dark:bg-[#151e32] border-b border-gray-200 dark:border-white/5 px-4 py-3">
                ...
                <div className={`overflow-hidden transition-all duration-300 ${mobileMenuOpen ? "max-h-[80vh] mt-3" : "max-h-0"}`}>
                    <nav className="space-y-1 pb-3">
                        ...
                        <div className="pt-2 mt-2 border-t border-gray-200 dark:border-white/5 flex items-center justify-between px-2">
