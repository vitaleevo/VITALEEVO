                ...
                <div className="max-w-md w-full px-4">
                    ...
                    <div className="bg-white dark:bg-[#151e32] p-8 md:p-10 rounded-3xl shadow-xl border border-gray-100 dark:border-white/5">
                        <div className="text-center mb-10">
                            <h1 className="font-display font-black text-3xl text-gray-900 dark:text-white mb-2">Bem-vindo de volta</h1>
                            <p className="text-gray-500 dark:text-gray-400">Acesse sua conta para gerenciar seus pedidos.</p>
                        </div>
                        ...
                        <form className="space-y-6">
                            ...
                            <button className="w-full bg-primary hover:bg-primary-dark text-white py-4 rounded-xl font-bold text-lg shadow-lg shadow-primary/20 transition-all hover:-translate-y-1">
                                Entrar
                            </button>
                        </form>
                        ...
                        <div className="mt-8 pt-8 border-t border-gray-100 dark:border-white/5 text-center">
                            <p className="text-gray-500 dark:text-gray-400 text-sm">
                                Não tem uma conta? <Link href="/auth/register" className="text-primary font-bold hover:underline">Criar conta grátis</Link>
                            </p>
                        </div>
                    </div>
