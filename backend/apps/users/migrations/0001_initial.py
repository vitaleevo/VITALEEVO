    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Administrador'), ('commercial', 'Comercial'), ('content', 'Conteúdo'), ('operations', 'Operações'), ('user', 'Utilizador')], default='user', max_length=20, verbose_name='cargo')),
